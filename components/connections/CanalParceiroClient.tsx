    ...
    <div className="flex flex-col gap-4">
      <Card className="flex flex-col gap-4 p-4">
        <div className="flex items-start justify-between gap-3">
          <div>
            <h3 className="text-sm font-semibold">{t("Conectar por {rotulo}", { rotulo })}</h3>
      ...
      {recemConectado && (
        <Card className="flex flex-col gap-4 border-warning/40 bg-warning-bg p-4">
          ...
          {recemConectado.quality_rating && (
            <p className="text-xs text-muted-foreground">
              {t("Qualidade do número segundo a plataforma: {qualidade}", {
                qualidade: recemConectado.quality_rating,
              })}
            </p>
          )}
        </Card>
