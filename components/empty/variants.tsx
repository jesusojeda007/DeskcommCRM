...
export function EmptyKanban({ primary, secondary }: VariantProps = {}) {
  ...
  return (
    <EmptyState
      icon={Kanban}
      headline={t("Pipeline vazio")}
      subcopy={t("Crie um lead pra começar a movimentar cards entre as etapas.")}
      primary={primary}
      secondary={secondary}
    />
  );
...
export function EmptyPipeline({ primary, secondary }: VariantProps = {}) {
  ...
  return (
    <EmptyState
      icon={GitBranch}
      headline={t("Sem pipelines configurados")}
      subcopy={t("Crie um pipeline pra organizar leads em etapas.")}
      primary={primary}
      secondary={secondary}
    />
  );
