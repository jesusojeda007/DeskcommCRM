...
export const DICIONARIO: Traducoes = {
  ...
  // ─── Fase 7: banners globais + empty states — español ───
  "está desconectado": { es: "está desconectado" },
  "{n} conexões": { es: "{n} conexiones" },
  "de WhatsApp estão desconectadas": { es: "de WhatsApp están desconectadas" },
  " — nenhuma mensagem entra nem sai.": { es: " — no entra ni sale ningún mensaje." },
  ...
  "Encerrando…": { es: "Cerrando…" },
  "Falha ao encerrar impersonate": { es: "Fallo al cerrar el impersonate" },
  "Erro de rede ao encerrar impersonate": { es: "Error de red al cerrar el impersonate" },
  "Encerrar impersonate e voltar ao admin": { es: "Cerrar el impersonate y volver al admin" },
  "Sem conversas por aqui": { es: "Sin conversaciones por acá" },
  "Quando chegarem mensagens, elas aparecem aqui em tempo real.": { es: "Cuando lleguen mensajes, van a aparecer acá en tiempo real." },
  "Pipeline vazio": { es: "Pipeline vacío" },
  "Crie um lead pra começar a movimentar cards entre as etapas.": { es: "Creá un lead para empezar a mover cards entre las etapas." },
  "Nenhum contato ainda": { es: "Todavía no hay ningún contacto" },
  "Contatos chegam automaticamente via WhatsApp ou Nuvemshop.": { es: "Los contactos llegan automáticamente vía WhatsApp o Nuvemshop." },
  "Sem eventos no período": { es: "Sin eventos en el período" },
  "Ajuste o filtro de datas ou a busca pra ver eventos.": { es: "Ajustá el filtro de fechas o la búsqueda para ver eventos." },
  "Sem pipelines configurados": { es: "Sin pipelines configurados" },
  "Crie um pipeline pra organizar leads em etapas.": { es: "Creá un pipeline para organizar leads en etapas." },
  "Sem membros no time": { es: "Sin miembros en el equipo" },
  "Convide colegas pra atender em conjunto.": { es: "Invitá colegas para atender en conjunto." },
  "Nenhum token criado": { es: "Ningún token creado" },
  "Tokens permitem integrações server-to-server.": { es: "Los tokens permiten integraciones server-to-server." },
  "Sem atividades registradas": { es: "Sin actividades registradas" },
  "A timeline mostra mensagens, mudanças de stage e notas.": { es: "La timeline muestra mensajes, cambios de stage y notas." },
  ...
  // ─── Fase 7: Inbox — media + retention-copy — español ───
  "Pausar áudio": { es: "Pausar audio" },
  "Reproduzir áudio": { es: "Reproducir audio" },
  "Progresso do áudio": { es: "Progreso del audio" },
  "{atual} de {total}": { es: "{atual} de {total}" },
  "Velocidade de reprodução: {taxa}x": { es: "Velocidad de reproducción: {taxa}x" },
  "Baixar {label} ({tamanho})": { es: "Descargar {label} ({tamanho})" },
  "Áudio": { es: "Audio" },
  "Imagem": { es: "Imagen" },
  "Figurinha": { es: "Sticker" },
  "Vídeo": { es: "Video" },
  "Arquivo": { es: "Archivo" },
  "Mídia indisponível": { es: "Contenido multimedia no disponible" },
  ...
  "Fora da janela de envio ({janela}). A resposta fica agendada para a próxima abertura da janela, às {hora}h — isso protege o número contra bloqueio do WhatsApp.": { es: "Fuera de la ventana de envío ({janela}). La respuesta queda agendada para la próxima apertura de la ventana, a las {hora}h — esto protege el número contra el bloqueo de WhatsApp." },
  "Este número ainda está em aquecimento e o limite diário de envios dele foi atingido. Enviar além disso arriscaria bloqueio pelo WhatsApp — libera de novo amanhã, a partir das {hora}h.": { es: "Este número todavía está en calentamiento y su límite diario de envíos ya se alcanzó. Enviar más allá de eso arriesgaría un bloqueo de WhatsApp — se libera de nuevo mañana, a partir de las {hora}h." },
  "O limite diário de envios do número foi atingido — proteção contra bloqueio do WhatsApp. Libera de novo amanhã, a partir das {hora}h.": { es: "Se alcanzó el límite diario de envíos del número — protección contra bloqueo de WhatsApp. Se libera de nuevo mañana, a partir de las {hora}h." },
  "A mesma mensagem estava se repetindo em massa por este número. O envio foi segurado para variar o texto e não parecer robô para o WhatsApp.": { es: "El mismo mensaje se estaba repitiendo en masa por este número. El envío quedó retenido para variar el texto y no parecer un robot ante WhatsApp." },
  "O contato pediu para não receber mensagens (opt-out). Nada será enviado a ele.": { es: "El contacto pidió no recibir mensajes (opt-out). No se le va a enviar nada." },
  "Este contato foi anonimizado (LGPD) — é proibido enviar qualquer mensagem a ele.": { es: "Este contacto fue anonimizado (LGPD) — está prohibido enviarle cualquier mensaje." },
  "Não há base legal (LGPD) para o primeiro contato de prospecção com este lead. O time precisa regularizar o cadastro antes de abordar.": { es: "No hay base legal (LGPD) para el primer contacto de prospección con este lead. El equipo necesita regularizar el registro antes de abordarlo." },
  "A resposta prometia um preço ou condição fora da tabela aprovada. O assistente foi orientado a corrigir antes de enviar.": { es: "La respuesta prometía un precio o condición fuera de la tabla aprobada. Se le indicó al asistente que corrija antes de enviar." },
  "A resposta continha uma promessa não autorizada. O assistente foi orientado a reescrever antes de enviar.": { es: "La respuesta contenía una promesa no autorizada. Se le indicó al asistente que reescriba antes de enviar." },
