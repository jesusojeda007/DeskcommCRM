...
function ScheduleDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          <DialogTitle>{t("Horário de {nome}", { nome: attendant.name })}</DialogTitle>
          <DialogDescription>
            {t(
                    ...
                    <TableCell>
                      {canManage ? (
                        <Input
                          ...
                          className="h-8 w-20"
                          aria-label={t("Capacidade de {nome}", { nome: a.name })}
                          onBlur={(e) => {
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        {canManage ? (
                          <Button
                            ...
                            size="icon"
                            className="h-7 w-7"
                            aria-label={t("Editar horário de {nome}", { nome: a.name })}
                    ...
                    {canManage ? (
                      <TableCell>
                        <Switch
                          ...
                          aria-label={t("Disponibilidade de {nome}", { nome: a.name })}
                          onCheckedChange={(v) =>
