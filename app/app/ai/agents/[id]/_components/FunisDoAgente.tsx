      ...
      {mudosMarcados.length > 0 ? (
        <p data-testid="agente-funis-mudos" className="text-xs text-warning-fg">
          {mudosMarcados.length === 1
            ? t(
                "Você marcou {nome}, mas ninguém disse ao assistente o que cada etapa desse funil significa — ele vai atender e deixar os negócios parados onde estão.",
                { nome: mudosMarcados[0] ?? "" },
              )
            : t(
                "Você marcou {n} funis em que ninguém disse ao assistente o que cada etapa significa — ele vai atender e deixar os negócios parados onde estão.",
                { n: mudosMarcados.length },
              )}{" "}
