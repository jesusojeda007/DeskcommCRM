...
function lastReceivedLabel(iso: string | null, t: ReturnType<typeof useT>): string {
  if (!iso) return t("nunca recebeu");
  return t("último recebimento {tempo}", {
    tempo: formatDistanceToNowStrict(new Date(iso), { addSuffix: true, locale: ptBR }),
  });
}
